...
// OverrideHandshakeHost replaces the virtual host and re-encodes the packet context.
func OverrideHandshakeHost(pc *proto.PacketContext, h *packet.Handshake, host string) {
